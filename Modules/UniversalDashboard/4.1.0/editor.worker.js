...
(function (Event) {
    ...
    function any() {
        ...
        return function (listener, thisArgs, disposables) {
            if (thisArgs === void 0) { thisArgs = null; }
            return (0,_lifecycle_js__WEBPACK_IMPORTED_MODULE_2__.combinedDisposable)(events.map(function (event) { return event(function (e) { return listener.call(thisArgs, e); }, null, disposables); }));
        };
    }
    Event.any = any;
    /**
...
/* harmony export */   "getSequenceIterator": () => (/* binding */ getSequenceIterator),
/* harmony export */   "ArrayIterator": () => (/* binding */ ArrayIterator),
/* harmony export */   "ArrayNavigator": () => (/* binding */ ArrayNavigator),
/* harmony export */   "MappedIterator": () => (/* binding */ MappedIterator)
/* harmony export */ });
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
...
var SimpleWorkerServer = /** @class */ (function () {
    ...
    SimpleWorkerServer.prototype.initialize = function (workerId, moduleId, loaderConfig) {
        ...
        if (this._requestHandler) {
            ...
            var methods = [];
            for (var _i = 0, _a = (0,_types_js__WEBPACK_IMPORTED_MODULE_3__.getAllPropertyNames)(this._requestHandler); _i < _a.length; _i++) {
                var prop = _a[_i];
        ...
        return new Promise(function (resolve, reject) {
            ...
            self.require([moduleId], function () {
                ...
                var methods = [];
                for (var _a = 0, _b = (0,_types_js__WEBPACK_IMPORTED_MODULE_3__.getAllPropertyNames)(_this._requestHandler); _a < _b.length; _a++) {
                    var prop = _b[_a];
...
var CharacterClassifier = /** @class */ (function () {
    function CharacterClassifier(_defaultValue) {
        var defaultValue = (0,_uint_js__WEBPACK_IMPORTED_MODULE_0__.toUint8)(_defaultValue);
    ...
    CharacterClassifier.prototype.set = function (charCode, _value) {
        var value = (0,_uint_js__WEBPACK_IMPORTED_MODULE_0__.toUint8)(_value);
...
/* harmony export */   "EditorSimpleWorkerImpl": () => (/* binding */ EditorSimpleWorkerImpl),
/* harmony export */   "create": () => (/* binding */ create)
/* harmony export */ });
...
var MirrorModel = /** @class */ (function (_super) {
    ...
    MirrorModel.prototype.getWordAtPosition = function (position, wordDefinition) {
        var wordAtText = (0,_model_wordHelper_js__WEBPACK_IMPORTED_MODULE_9__.getWordAtText)(position.column, (0,_model_wordHelper_js__WEBPACK_IMPORTED_MODULE_9__.ensureValidWordDefinition)(wordDefinition), this._lines[position.lineNumber - 1], 0);
        if (wordAtText) {
...
var BaseEditorSimpleWorker = /** @class */ (function () {
    ...
    BaseEditorSimpleWorker.prototype.computeMoreMinimalEdits = function (modelUrl, edits) {
        ...
        edits = (0,_base_common_arrays_js__WEBPACK_IMPORTED_MODULE_0__.mergeSort)(edits, function (a, b) {
            if (a.range && b.range) {
        ...
        for (var _i = 0, edits_1 = edits; _i < edits_1.length; _i++) {
            ...
            var changes = (0,_base_common_diff_diff_js__WEBPACK_IMPORTED_MODULE_1__.stringDiff)(original, text, false);
    ...
    BaseEditorSimpleWorker.prototype.computeLinks = function (modelUrl) {
        ...
        return Promise.resolve((0,_modes_linkComputer_js__WEBPACK_IMPORTED_MODULE_10__.computeLinks)(model));
    };
    ...
    BaseEditorSimpleWorker.prototype.loadForeignModule = function (moduleId, createData) {
        ...
        if (this._foreignModuleFactory) {
            ...
            var methods = [];
            for (var _i = 0, _a = (0,_base_common_types_js__WEBPACK_IMPORTED_MODULE_13__.getAllPropertyNames)(this._foreignModule); _i < _a.length; _i++) {
                var prop = _a[_i];
...
if (typeof importScripts === 'function') {
    ...
    _base_common_platform_js__WEBPACK_IMPORTED_MODULE_3__.globals.monaco = (0,_standalone_standaloneBase_js__WEBPACK_IMPORTED_MODULE_12__.createMonacoBaseAPI)();
}
...
var KeyMod = /** @class */ (function () {
    ...
    KeyMod.chord = function (firstPart, secondPart) {
        return (0,_base_common_keyCodes_js__WEBPACK_IMPORTED_MODULE_3__.KeyChord)(firstPart, secondPart);
    };
...
/* harmony export */   "PrefixSumComputerWithCache": () => (/* binding */ PrefixSumComputerWithCache)
/* harmony export */ });
...
var PrefixSumComputer = /** @class */ (function () {
    ...
    PrefixSumComputer.prototype.insertValues = function (insertIndex, insertValues) {
        insertIndex = (0,_core_uint_js__WEBPACK_IMPORTED_MODULE_0__.toUint32)(insertIndex);
    ...
    PrefixSumComputer.prototype.changeValue = function (index, value) {
        index = (0,_core_uint_js__WEBPACK_IMPORTED_MODULE_0__.toUint32)(index);
        value = (0,_core_uint_js__WEBPACK_IMPORTED_MODULE_0__.toUint32)(value);
    ...
    PrefixSumComputer.prototype.removeValues = function (startIndex, cnt) {
        startIndex = (0,_core_uint_js__WEBPACK_IMPORTED_MODULE_0__.toUint32)(startIndex);
        cnt = (0,_core_uint_js__WEBPACK_IMPORTED_MODULE_0__.toUint32)(cnt);
        var oldValues = this.values;
        var oldPrefixSum = this.prefixSum;
...
/******/ })()
;
//# sourceMappingURL=main.35eb8a3137b41007e447f57f7c5922c0.bundle.map