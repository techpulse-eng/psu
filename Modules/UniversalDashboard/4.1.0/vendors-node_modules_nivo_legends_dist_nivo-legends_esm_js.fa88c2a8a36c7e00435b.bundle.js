(self["webpackChunkmaterialui"] = self["webpackChunkmaterialui"] || []).push([["vendors-node_modules_nivo_legends_dist_nivo-legends_esm_js"],{
...
/* harmony export */   "ANCHOR_BOTTOM": () => (/* binding */ ANCHOR_BOTTOM),
/* harmony export */   "ANCHOR_BOTTOM_LEFT": () => (/* binding */ ANCHOR_BOTTOM_LEFT),
/* harmony export */   "ANCHOR_BOTTOM_RIGHT": () => (/* binding */ ANCHOR_BOTTOM_RIGHT),
/* harmony export */   "ANCHOR_CENTER": () => (/* binding */ ANCHOR_CENTER),
/* harmony export */   "ANCHOR_LEFT": () => (/* binding */ ANCHOR_LEFT),
/* harmony export */   "ANCHOR_RIGHT": () => (/* binding */ ANCHOR_RIGHT),
/* harmony export */   "ANCHOR_TOP": () => (/* binding */ ANCHOR_TOP),
/* harmony export */   "ANCHOR_TOP_LEFT": () => (/* binding */ ANCHOR_TOP_LEFT),
/* harmony export */   "ANCHOR_TOP_RIGHT": () => (/* binding */ ANCHOR_TOP_RIGHT),
/* harmony export */   "BoxLegendSvg": () => (/* binding */ BoxLegendSvg),
/* harmony export */   "DIRECTION_BOTTOM_TO_TOP": () => (/* binding */ DIRECTION_BOTTOM_TO_TOP),
/* harmony export */   "DIRECTION_COLUMN": () => (/* binding */ DIRECTION_COLUMN),
/* harmony export */   "DIRECTION_LEFT_TO_RIGHT": () => (/* binding */ DIRECTION_LEFT_TO_RIGHT),
/* harmony export */   "DIRECTION_RIGHT_TO_LEFT": () => (/* binding */ DIRECTION_RIGHT_TO_LEFT),
/* harmony export */   "DIRECTION_ROW": () => (/* binding */ DIRECTION_ROW),
/* harmony export */   "DIRECTION_TOP_TO_BOTTOM": () => (/* binding */ DIRECTION_TOP_TO_BOTTOM),
/* harmony export */   "LegendPropShape": () => (/* binding */ LegendPropShape),
/* harmony export */   "LegendSvg": () => (/* binding */ LegendSvg),
/* harmony export */   "LegendSvgItem": () => (/* binding */ LegendSvgItem),
/* harmony export */   "datumPropType": () => (/* binding */ datumPropType),
/* harmony export */   "interactivityPropTypes": () => (/* binding */ interactivityPropTypes),
/* harmony export */   "legendEffectPropType": () => (/* binding */ legendEffectPropType),
/* harmony export */   "renderLegendToCanvas": () => (/* binding */ renderLegendToCanvas),
/* harmony export */   "symbolPropTypes": () => (/* binding */ symbolPropTypes),
/* harmony export */   "useQuantizeColorScaleLegendData": () => (/* binding */ useQuantizeColorScaleLegendData)
/* harmony export */ });
...
var legendEffectPropType = prop_types__WEBPACK_IMPORTED_MODULE_5___default().shape({
  on: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOf(['hover'])]).isRequired,
  style: prop_types__WEBPACK_IMPORTED_MODULE_5___default().shape({
    itemTextColor: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string),
    itemBackground: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string),
    itemOpacity: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
    symbolSize: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
    symbolBorderWidth: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
    symbolBorderColor: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string)
  }).isRequired
});
var symbolPropTypes = {
  symbolShape: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_5___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_5___default().func)]),
  symbolSize: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  symbolSpacing: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  symbolBorderWidth: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  symbolBorderColor: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string)
};
...
var datumPropType = prop_types__WEBPACK_IMPORTED_MODULE_5___default().shape({
  ...
  label: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_5___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number)]).isRequired,
...
var LegendPropShape = _objectSpread({
  data: prop_types__WEBPACK_IMPORTED_MODULE_5___default().arrayOf(datumPropType),
  anchor: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOf([ANCHOR_TOP, ANCHOR_TOP_RIGHT, ANCHOR_RIGHT, ANCHOR_BOTTOM_RIGHT, ANCHOR_BOTTOM, ANCHOR_BOTTOM_LEFT, ANCHOR_LEFT, ANCHOR_TOP_LEFT, ANCHOR_CENTER]).isRequired,
  ...
  direction: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOf([DIRECTION_ROW, DIRECTION_COLUMN]).isRequired,
  itemsSpacing: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  itemWidth: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  itemHeight: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  itemDirection: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOf([DIRECTION_LEFT_TO_RIGHT, DIRECTION_RIGHT_TO_LEFT, DIRECTION_TOP_TO_BOTTOM, DIRECTION_BOTTOM_TO_TOP]),
  itemTextColor: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string),
  itemBackground: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string),
  itemOpacity: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number)
}, symbolPropTypes, interactivityPropTypes, {
  effects: prop_types__WEBPACK_IMPORTED_MODULE_5___default().arrayOf(legendEffectPropType)
});
...
var computeDimensions = function computeDimensions(_ref) {
  ...
  var padding;
  if (lodash_isNumber__WEBPACK_IMPORTED_MODULE_3___default()(_padding)) {
    padding = {
      top: _padding,
      right: _padding,
      bottom: _padding,
  ...
  } else if (lodash_isPlainObject__WEBPACK_IMPORTED_MODULE_4___default()(_padding)) {
...
var symbolPropTypes$1 = {
  x: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  y: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  size: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  fill: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string.isRequired),
  borderWidth: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  borderColor: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string.isRequired)
};
...
var LegendSvgItem = function LegendSvgItem(_ref) {
  ...
  var theme = (0,_nivo_core__WEBPACK_IMPORTED_MODULE_2__.useTheme)();
  ...
  }), react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Symbol, {
    x: symbolX,
    y: symbolY,
...
LegendSvgItem.propTypes = _objectSpread$6({
  ...
  height: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  textColor: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string),
  background: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string),
  opacity: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  direction: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOf(['left-to-right', 'right-to-left', 'top-to-bottom', 'bottom-to-top']).isRequired,
  justify: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool.isRequired)
}, symbolPropTypes, interactivityPropTypes);
...
LegendSvg.propTypes = _objectSpread$7({
  data: prop_types__WEBPACK_IMPORTED_MODULE_5___default().arrayOf(datumPropType).isRequired,
  x: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  y: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  direction: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOf(['row', 'column']).isRequired,
  padding: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_5___default().number), prop_types__WEBPACK_IMPORTED_MODULE_5___default().shape({
  ...
  justify: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool.isRequired),
  itemsSpacing: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  itemWidth: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  itemHeight: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  itemDirection: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOf([DIRECTION_LEFT_TO_RIGHT, DIRECTION_RIGHT_TO_LEFT, DIRECTION_TOP_TO_BOTTOM, DIRECTION_BOTTOM_TO_TOP]).isRequired,
  itemTextColor: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string.isRequired),
  itemBackground: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string.isRequired),
  itemOpacity: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired)
}, symbolPropTypes, interactivityPropTypes);
...
BoxLegendSvg.propTypes = _objectSpread$8({
  data: prop_types__WEBPACK_IMPORTED_MODULE_5___default().arrayOf(datumPropType).isRequired,
  containerWidth: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  containerHeight: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  translateX: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  translateY: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  anchor: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOf([ANCHOR_TOP, ANCHOR_TOP_RIGHT, ANCHOR_RIGHT, ANCHOR_BOTTOM_RIGHT, ANCHOR_BOTTOM, ANCHOR_BOTTOM_LEFT, ANCHOR_LEFT, ANCHOR_TOP_LEFT, ANCHOR_CENTER]).isRequired,
  direction: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOf([DIRECTION_ROW, DIRECTION_COLUMN]).isRequired,
  padding: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_5___default().number), prop_types__WEBPACK_IMPORTED_MODULE_5___default().shape({
    top: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number),
  ...
  justify: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().bool),
  itemWidth: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  itemHeight: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
  itemDirection: prop_types__WEBPACK_IMPORTED_MODULE_5___default().oneOf([DIRECTION_LEFT_TO_RIGHT, DIRECTION_RIGHT_TO_LEFT, DIRECTION_TOP_TO_BOTTOM, DIRECTION_BOTTOM_TO_TOP]),
  itemsSpacing: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number.isRequired),
...
//# sourceMappingURL=vendors-node_modules_nivo_legends_dist_nivo-legends_esm_js.5a440159801a395a1f0da2cffa6b345a.bundle.map